...
import sys
sys.path.insert(0, '/Users/samipdahal/Google Drive/ende/asdl_copy')
...
def preprocess_conala_dataset(train_file, test_file, grammar_file, src_freq=3, code_freq=3,
    ...
    #         print ('this is the src: ',e.src_sent)
    #         print ('this is the input ',e.input_actions)
    #         print ('this is the output ',e.tgt_actions)
    #         for j in e.tgt_actions:
    #             if isinstance(j.action,GenTokenAction):
    #                 print (j)
    #     else:
    #         break
    #     a+=1
