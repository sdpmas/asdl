...
class ConalaEvaluator(Evaluator):
    ...
    def evaluate_dataset(self, dataset, decode_results, fast_mode=False, args=None):
        ...
        try:
            d=[o for o in decode_results if o]
            if not hasattr(d[0][0], 'decanonical_code_tokens'):
        ...
        if fast_mode:
            ...
            print (len(references), 'this is the reference code ',len(hypotheses),'this is the hypotheses')
